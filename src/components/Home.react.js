...
class Home extends Component {
  constructor() {
    ...
    this.state = {
      ...
      duration: 16,
      steps: 24,
      channels: ['m1','d2','m3', 'm4', 'm5', 'm6', 'm7', 'm8', 'm9', 'm10', 'm11', 'm12', 'm13', 'm14', 'm15', 'm16' ],
  ...
  render() {
    ...
    return <div className="Home cont">
      ...
      <div id="SCmsg">
       Supercollider msgs
      <input type="text" value={scCommand} onChange={updateScCommand} placeholder="ScCommand" onKeyUp = {ctx.handleSubmit.bind(ctx)}/>
        </div>
      </div>
    </div>
  }
